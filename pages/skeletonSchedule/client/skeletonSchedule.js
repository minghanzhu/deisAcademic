...
Template.skeletonSchedule.onCreated(function(){
...
Template.skeletonSchedule.onRendered(function(){
...
Template.skeletonSchedule.helpers({
...
Template.skeletonSchedule.events({
...
Template.scheduleSectionList.onCreated(function(){
	this.schCourseDict = new ReactiveDict();
})

Template.scheduleSectionList.onRendered(function(){
	$('.accordion').accordion();
})

Template.scheduleSectionList.helpers({
