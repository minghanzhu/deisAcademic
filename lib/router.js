...
Router.route('/majorPlan/new', {
	...
	waitOn: function(){
		return [Meteor.subscribe("new_plan_profData"), Meteor.subscribe("new_plan_term"), Meteor.subscribe("major"), Meteor.subscribe("new_plan_userProfile")];
	},
	action: function(){
...
Router.route('/majorPlan/:_id',{
	waitOn: function(){
		return [Meteor.subscribe("modify_plan_term"), Meteor.subscribe("modify_plan_majorPlans", this.params._id), Meteor.subscribe("major"), Meteor.subscribe("modify_plan_userProfile"), Meteor.subscribe("modify_plan_profData")];
	},
	data: function(){
		return {
			isModify: true,
